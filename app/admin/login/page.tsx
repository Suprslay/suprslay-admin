...
import CanvasAnimation from "@/components/canvas-animation-fix"
...
export default function AdminLogin() {
  ...
  const returnUrl = searchParams.get("returnUrl") || "/admin/waitlist"
          ...
          <div className="bg-white rounded-2xl shadow-xl overflow-hidden">
            ...
            <div className="p-6">
              ...
              <div className="mt-4 text-center">
                <Link href="/" className="text-sm text-gray-500 hover:text-[#e43d12]">
                  Return to Home
                </Link>
              </div>
            </div>
